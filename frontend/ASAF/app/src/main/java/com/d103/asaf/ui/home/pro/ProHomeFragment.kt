...
//    private val proHomeFragmentViewModel: ProHomeFragmentViewModel by viewModels()
    ...
    fun initToggleButton(){
        ...
        binding.fragmentProHomeCustoomtoggleButton.setFirstButtonClickListener {
            ...
            var user4 = Member(4, 123, "Test", "test@test.com",
                "test",
            ...
            var user5 = Member(5, 123, "Test", "test@test.com",
                "test",
            ...
            studentInfoList.add(AttendanceInfo(1, 2, convertLongToSqlTime(System.currentTimeMillis()), convertLongToSqlTime(System.currentTimeMillis()+1), user1 ))
            ...
            attendedPercent = (attendedCount/studentInfoList.size.toFloat() * 100.0).toFloat()
    ...
    fun progressBarUpdate() {
        binding.fragmentProHomeArcProgressBar.progressText.text = "TEST"
