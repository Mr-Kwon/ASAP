...
//    private val proHomeFragmentViewModel: ProHomeFragmentViewModel by viewModels()
    ...
    private var studentInfoList : MutableList<AttendanceInfo> = mutableListOf()
    ...
    fun initToggleButton(){
        ...
        binding.fragmentProHomeCustoomtoggleButton.setSecondButtonClickListener {

        }
        binding.fragmentProHomeCustoomtoggleButton.setThirdButtonClickListener {
    ...
    fun initstudentList(){
        ...
        studentInfoList.add(AttendanceInfo(1, 1, convertLongToSqlTime(System.currentTimeMillis()), convertLongToSqlTime(System.currentTimeMillis()+1), user1 ))
        studentInfoList.add(AttendanceInfo(1, 2, convertLongToSqlTime(System.currentTimeMillis()), convertLongToSqlTime(System.currentTimeMillis()+1), user2 ))
        studentInfoList.add(AttendanceInfo(1, 1, convertLongToSqlTime(System.currentTimeMillis()), convertLongToSqlTime(System.currentTimeMillis()+1), user3 ))
        studentInfoList.add(AttendanceInfo(1, 2, convertLongToSqlTime(System.currentTimeMillis()), convertLongToSqlTime(System.currentTimeMillis()+1), user4 ))
        studentInfoList.add(AttendanceInfo(1, 2, convertLongToSqlTime(System.currentTimeMillis()), convertLongToSqlTime(System.currentTimeMillis()+1), user5 ))
        studentInfoList.add(AttendanceInfo(1, 2, convertLongToSqlTime(System.currentTimeMillis()), convertLongToSqlTime(System.currentTimeMillis()+1), user5 ))
        studentInfoList.add(AttendanceInfo(1, 2, convertLongToSqlTime(System.currentTimeMillis()), convertLongToSqlTime(System.currentTimeMillis()+1), user6 ))
        studentInfoList.add(AttendanceInfo(1, 2, convertLongToSqlTime(System.currentTimeMillis()), convertLongToSqlTime(System.currentTimeMillis()+1), user7 ))
        studentInfoList.add(AttendanceInfo(1, 2, convertLongToSqlTime(System.currentTimeMillis()), convertLongToSqlTime(System.currentTimeMillis()+1), user8 ))
        studentInfoList.add(AttendanceInfo(1, 2, convertLongToSqlTime(System.currentTimeMillis()), convertLongToSqlTime(System.currentTimeMillis()+1), user9 ))



        var attendedCount  = 0f
        for(student : AttendanceInfo in studentInfoList){
            if(student.attended == 2){
                attendedCount++;
            }

        }
        attendedPercent = (attendedCount/studentInfoList.size.toFloat() * 100).toInt().toFloat()
